...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> server.ts
    </h1>
    <div class='clearfix'>
...
&nbsp;
    ...
    public static loadServices(router: express.Router, patterns: string | Array&lt;string&gt;, baseDir?: string) {
        ...
        baseDir = baseDir || <span class="branch-1 cbranch-no" title="branch not covered" >process.cwd();</span>
...
<span class="cstat-no" title="statement not covered" >            throw new TypeError(`Error loading services for pattern: ${JSON.stringify(patterns)}. Error: ${e.message}`);</span>
        }
    }
&nbsp;
    /**
...
&nbsp;
    ...
    public static useIoC(es6?: boolean) {
        const ioc = require(es6 ? <span class="branch-0 cbranch-no" title="branch not covered" >'typescript-ioc/es6' </span>: 'typescript-ioc');
...
<span class="cstat-no" title="statement not covered" >                throw TypeError('Can not identify the base Type for requested target');</span>
            }
        });
    }
&nbsp;
...
&nbsp;
     ...
     */
<span class="fstat-no" title="function not covered" >    public static setCookiesSecret(</span>secret: string) {
<span class="cstat-no" title="statement not covered" >        InternalServer.cookiesSecret = secret;</span>
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    public static setCookiesDecoder(</span>decoder: (val: string) =&gt; string) {
<span class="cstat-no" title="statement not covered" >        InternalServer.cookiesDecoder = decoder;</span>
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    public static setFileDest(</span>dest: string) {
<span class="cstat-no" title="statement not covered" >        InternalServer.fileDest = dest;</span>
    }
&nbsp;
    /**
     ...
     */
<span class="fstat-no" title="function not covered" >    public static setFileFilter(</span>filter: (req: Express.Request, file: Express.Multer.File,
        callback: (error: Error, acceptFile: boolean) =&gt; void) =&gt; void) {
<span class="cstat-no" title="statement not covered" >        InternalServer.fileFilter = filter;</span>
    }
&nbsp;
    /**
...
&nbsp;
    ...
    public static swagger(router: express.Router, filePath: string, endpoint: string, host?: string, schemes?: Array&lt;string&gt;, swaggerUiOptions?: object) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.startsWith(filePath, '.')) {
            filePath = path.join(process.cwd(), filePath);
        }
&nbsp;
        let swaggerDocument: any;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (_.endsWith(filePath, '.yml') || _.endsWith(filePath, '.yaml')) {
            swaggerDocument = YAML.load(filePath);
        } else {
<span class="cstat-no" title="statement not covered" >            swaggerDocument = fs.readJSONSync(filePath);</span>
        }
&nbsp;
        <span class="missing-if-branch" title="else path not taken" >E</span>if (host) {
            swaggerDocument.host = host;
        }
        <span class="missing-if-branch" title="else path not taken" >E</span>if (schemes) {
