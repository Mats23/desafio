...
<html lang="en">
<head>
    <title>Code coverage report for decorators.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> decorators.ts
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">84.11% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>254/302</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">70.71% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>140/198</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        <span class="strong">82.24% </span>
        <span class="quiet">Lines</span>
        <span class='fraction'>213/259</span>
      </div>
    </div>
    <p class="quiet">
...
<a name='L1086'></a><a href='#L1086'>1086</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
export function Path(path: string) {
    return function (...args: Array&lt;any&gt;) {
        ...
        } else <span class="missing-if-branch" title="else path not taken" >E</span>if (args.length === 3 &amp;&amp; typeof args[2] === 'object') {
            return PathMethodDecorator.apply(this, [args[0], args[1], args[2], path]);
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @Path Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @Security Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @Preprocessor Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @AcceptLanguage Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @Accept Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
export function Context(...args: Array&lt;any&gt;) {
    ...
    <span class="missing-if-branch" title="else path not taken" >E</span>if (args.length &lt; 3 || <span class="branch-1 cbranch-no" title="branch not covered" >typeof args[2] === 'undefined')</span> {
        return processDecoratedProperty.apply(this, newArgs);
    } else <span class="cstat-no" title="statement not covered" >if (args.length === 3 &amp;&amp; typeof args[2] === 'number') {</span>
<span class="cstat-no" title="statement not covered" >        return processDecoratedParameter.apply(this, newArgs);</span>
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid @Context Decorator declaration.');</span>
}
&nbsp;
/**
 * A decorator to be used on class properties or on service method arguments
...
export function ContextRequest(...args: Array&lt;any&gt;) {
    ...
    if (args.length &lt; 3 || typeof args[2] === 'undefined') {
        return processDecoratedProperty.apply(this, newArgs);
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (args.length === 3 &amp;&amp; typeof args[2] === 'number') {
        return processDecoratedParameter.apply(this, newArgs);
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid @ContextRequest Decorator declaration.');</span>
}
&nbsp;
/**
 * A decorator to be used on class properties or on service method arguments
...
export function ContextResponse(...args: Array&lt;any&gt;) {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (args.length &lt; 3 || typeof args[2] === 'undefined') {
<span class="cstat-no" title="statement not covered" >        return processDecoratedProperty.apply(this, newArgs);</span>
    } else <span class="missing-if-branch" title="else path not taken" >E</span>if (args.length === 3 &amp;&amp; typeof args[2] === 'number') {
        return processDecoratedParameter.apply(this, newArgs);
    }
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid @ContextResponse Decorator declaration.');</span>
}
&nbsp;
/**
 * A decorator to be used on class properties or on service method arguments
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid @ContextNext Decorator declaration.');</span>
}
&nbsp;
/**
 * A decorator to be used on class properties or on service method arguments
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid @ContextLanguage Decorator declaration.');</span>
}
&nbsp;
/**
 * A decorator to be used on class properties or on service method arguments
...
&nbsp;
<span class="cstat-no" title="statement not covered" >    throw new Error('Invalid @ContextAccept Decorator declaration.');</span>
}
&nbsp;
/**
 ...
 * ```
 */
export function <span class="fstat-no" title="function not covered" >HEAD(</span>target: any, propertyKey: string,
    descriptor: PropertyDescriptor) {
<span class="cstat-no" title="statement not covered" >    processHttpVerb(target, propertyKey, HttpMethod.HEAD);</span>
}
&nbsp;
/**
 * A decorator to tell the [[Server]] that a method
 ...
 * ```
 */
export function <span class="fstat-no" title="function not covered" >OPTIONS(</span>target: any, propertyKey: string,
    descriptor: PropertyDescriptor) {
<span class="cstat-no" title="statement not covered" >    processHttpVerb(target, propertyKey, HttpMethod.OPTIONS);</span>
}
&nbsp;
/**
 * A decorator to tell the [[Server]] that a method
 ...
 * ```
 */
export function <span class="fstat-no" title="function not covered" >PATCH(</span>target: any, propertyKey: string,
    descriptor: PropertyDescriptor) {
<span class="cstat-no" title="statement not covered" >    processHttpVerb(target, propertyKey, HttpMethod.PATCH);</span>
}
&nbsp;
/**
...
export function BodyOptions(options: any) {
    return function(target: any, propertyKey: string, descriptor: PropertyDescriptor) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (serviceMethod) { // does not intercept constructor
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @PathParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @FileParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
 ...
 * argument on addAvatar method's call.
 */
export function <span class="fstat-no" title="function not covered" >FilesParam(</span>name: string) {
<span class="cstat-no" title="statement not covered" >    return <span class="fstat-no" title="function not covered" >function (<span class="cstat-no" title="statement not covered" ><span class="cstat-no" title="statement not covered" >...args: Array&lt;any&gt;</span>)</span> {</span></span>
<span class="cstat-no" title="statement not covered" >        args = _.without(args, undefined);</span>
        const newArgs = <span class="cstat-no" title="statement not covered" >args.concat([metadata.ParamType.files, name]);</span>
<span class="cstat-no" title="statement not covered" >        if (args.length &lt; 3 || typeof args[2] === 'undefined') {</span>
<span class="cstat-no" title="statement not covered" >            return processDecoratedProperty.apply(this, newArgs);</span>
        } else <span class="cstat-no" title="statement not covered" >if (args.length === 3 &amp;&amp; typeof args[2] === 'number') {</span>
<span class="cstat-no" title="statement not covered" >            return processDecoratedParameter.apply(this, newArgs);</span>
        }
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @FilesParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @QueryParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @HeaderParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @CookieParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @FormParam Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
&nbsp;
<span class="cstat-no" title="statement not covered" >        throw new Error('Invalid @Param Decorator declaration.');</span>
    };
}
&nbsp;
/**
...
function PathTypeDecorator(target: Function, path: string) {
    const classData: metadata.ServiceClass = InternalServer.registerServiceClass(target);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (classData) {
        classData.path = path;
    }
}
&nbsp;
...
function PreprocessorTypeDecorator(target: Function, preprocessor: metadata.PreprocessorFunction) {
    const classData: metadata.ServiceClass = InternalServer.registerServiceClass(target);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (classData) {
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!classData.processors) {
...
function PreprocessorMethodDecorator(target: any, propertyKey: string,
    ...
    const serviceMethod: metadata.ServiceMethod = InternalServer.registerServiceMethod(target.constructor, propertyKey);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (serviceMethod) {
...
function processHttpVerb(target: any, propertyKey: string,
    ...
    const serviceMethod: metadata.ServiceMethod = InternalServer.registerServiceMethod(target.constructor, propertyKey);
    <span class="missing-if-branch" title="else path not taken" >E</span>if (serviceMethod) { // does not intercept constructor
        <span class="missing-if-branch" title="if path not taken" >I</span>if (serviceMethod.httpMethod &amp;&amp; serviceMethod.httpMethod !== httpMethod) {
<span class="cstat-no" title="statement not covered" >            throw new Error('Method is already annotated with @' +</span>
...
&nbsp;
    serviceMethod.parameters.forEach(param =&gt; {
        ...
        } else <span class="missing-if-branch" title="if path not taken" >I</span>if (param.paramType === metadata.ParamType.files) {
<span class="cstat-no" title="statement not covered" >            serviceMethod.files.push(new metadata.FileParam(param.name, false));</span>
            ...
            <span class="missing-if-branch" title="if path not taken" >I</span>if (serviceMethod.mustParseBody) {
<span class="cstat-no" title="statement not covered" >                throw Error('Can not use form parameters with a body parameter on the same method.');</span>
            }
            serviceMethod.mustParseForms = true;
        } else if (param.paramType === metadata.ParamType.body) {
            <span class="missing-if-branch" title="if path not taken" >I</span>if (serviceMethod.mustParseForms) {
<span class="cstat-no" title="statement not covered" >                throw Error('Can not use form parameters with a body parameter on the same method.');</span>
            }
            <span class="missing-if-branch" title="if path not taken" >I</span>if (serviceMethod.mustParseBody) {
<span class="cstat-no" title="statement not covered" >                throw Error('Can not use more than one body parameter on the same method.');</span>
            }
