...
<html lang="en">
<head>
    <title>Code coverage report for server-errors.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="index.html">All files</a> server-errors.ts
    </h1>
    <div class='clearfix'>
...
export class BadRequestError extends HttpError {
    constructor(message?: string) {
        super('BadRequestError', 400, message || 'Bad Request')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class UnauthorizedError extends HttpError {
    constructor(message?: string) {
        super('UnauthorizedError', 401, message || 'Unauthorized')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class ForbiddenError extends HttpError {
    constructor(message?: string) {
        super('ForbiddenError', 403, message || 'Forbidden')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class NotFoundError extends HttpError {
    constructor(message?: string) {
        super('NotFoundError', 404, message || 'Not Found')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class MethodNotAllowedError extends HttpError {
    constructor(message?: string) {
        super('MethodNotAllowedError', 405, message || 'Method Not Allowed')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class NotAcceptableError extends HttpError {
    constructor(message?: string) {
        super('NotAcceptableError', 406, message || 'Not Acceptable')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class ConflictError extends HttpError {
    constructor(message?: string) {
        super('ConflictError', 409, message || 'Conflict')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class GoneError extends HttpError {
    constructor(message?: string) {
        super('GoneError', 410, message || 'Gone')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class UnsupportedMediaTypeError extends HttpError {
    constructor(message?: string) {
        super('UnsupportedMediaTypeError', 415, message || 'Unsupported Media Type')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class InternalServerError extends HttpError {
    constructor(message?: string) {
        super('InternalServerError', 500, message || 'Internal Server Error')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class NotImplementedError extends HttpError {
    constructor(message?: string) {
        super('NotImplementedError', 501, message || 'Not Implemented')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
...
export class UnprocessableEntityError extends HttpError {
    constructor(message?: string) {
        super('UnprocessableEntityError', 422, message || 'Unprocessable Entity')<span class="branch-1 cbranch-no" title="branch not covered" >;</span>
