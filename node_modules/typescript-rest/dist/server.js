...
var Server = /** @class */ (function () {
    ...
    Server.registerAuthenticator = function (authenticator) {
        server_container_1.InternalServer.authenticator = authenticator;
    };
    /**
    ...
    Server.getHttpMethods = function (servicePath) {
        var result = new Array();
        server_container_1.InternalServer.getHttpMethods(servicePath).forEach(function (value) {
            result.push(value);
        });
        return result;
    };
     ...
     */
    Server.setParamConverter = function (fn) {
        server_container_1.InternalServer.paramConverter = fn;
    };
    /**
     ...
     */
    Server.swagger = function (router, filePath, endpoint, host, schemes, swaggerUiOptions) {
